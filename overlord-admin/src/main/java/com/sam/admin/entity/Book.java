...
public class Book implements Serializable{
	...
	public String toString() {
		return "Book [id=" + id + ", uuid=" + uuid + ", name=" + name + ", price=" + price + ", grade=" + grade
				+ ", remark=" + remark + ", count=" + count +", out_count=" + out_count+ ", author=" + author + ", press=" + press + ", version="
				+ version + ", pic_0=" + pic_0 + ", pic_1=" + pic_1 + ", pic_2=" + pic_2 + ", pic_3=" + pic_3
				+ ", pic_4=" + pic_4 + ", status=" + status + ", del_flag=" + del_flag + ", sort=" + sort + "]";
	}
